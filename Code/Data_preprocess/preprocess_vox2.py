...
def get_mouth_path(in_mouth_dir, wav_file, out_filename, data_type):
    ...
    if out_filename == "s1":
        file_path = os.path.join(in_mouth_dir, "{}.npz".format(res[0]))
    else:
        file_path = os.path.join(in_mouth_dir, "{}.npz".format(res[1]))
...
#     parser = argparse.ArgumentParser("vox2 data preprocessing")
#     parser.add_argument(
#         "--in_audio_dir",
#         type=str,
#         default=,
#         help="Directory path of audio“,
#     )
#     parser.add_argument(
#         "--in_mouth_dir",
#         type=str,
#         default=,
#         help="Directory path of video",
#     )
#     parser.add_argument("--out_dir", type=str, default="VOX2min", help="Directory path to put output files")
